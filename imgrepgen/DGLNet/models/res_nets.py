...
class ResNets:
    ...
    @staticmethod
    def create_model(model_name='resnet50', pretrained=False, chan_attn=False, spat_attn=False, num_classes=None):
        if model_name.lower() == 'resnet18':
            return ResNets.resnet18(pretrained=pretrained, chan_attn=chan_attn, spat_attn=spat_attn,
                                    num_classes=num_classes)
        elif model_name.lower() == 'resnet34':
            return ResNets.resnet34(pretrained=pretrained, chan_attn=chan_attn, spat_attn=spat_attn,
                                    num_classes=num_classes)
        elif model_name.lower() == 'resnet50':
            return ResNets.resnet50(pretrained=pretrained, chan_attn=chan_attn, spat_attn=spat_attn,
                                    num_classes=num_classes)
        elif model_name.lower() == 'resnet101':
            return ResNets.resnet101(pretrained=pretrained, chan_attn=chan_attn, spat_attn=spat_attn,
                                     num_classes=num_classes)
        elif model_name.lower() == 'resnet152':
            return ResNets.resnet152(pretrained=pretrained, chan_attn=chan_attn, spat_attn=spat_attn,
                                     num_classes=num_classes)
...
if __name__ == "__main__":
    ...
    cnn_model = ResNets.resnet101(pretrained=False, num_classes=14,chan_attn=True, spat_attn=True)
    res_net_out = cnn_model(imgs)
    print(res_net_out)
    # 查看预训练参数(Key)
