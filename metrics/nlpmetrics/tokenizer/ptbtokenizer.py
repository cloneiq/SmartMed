...
class PTBTokenizer:
    ...
    def tokenize(self, captions_for_image):
        ...
        cmd = ['java', '-cp', STANFORD_CORENLP_3_4_1_JAR, 'edu.stanford.nlp.process.PTBTokenizer',
               '-preserveLines', '-lowerCase', os.path.join(path_to_jar_dirname, os.path.basename(tmp_file.name))]
        # add shell=True
